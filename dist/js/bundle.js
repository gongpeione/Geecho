...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Wrap = exports.SearchBtn = exports.MenuBtnStatus = exports.MenuBtn = undefined;
	...
	var MenuBtn = exports.MenuBtn = function (_React$Component) {
	  ...
	  _createClass(MenuBtn, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'label',
	        { className: 'menu-button', htmlFor: 'menu-slider' },
	        _react2.default.createElement('div', { className: 'button-line' }),
	        _react2.default.createElement('div', { className: 'button-line' }),
	        _react2.default.createElement('div', { className: 'button-line' })
	      );
	    }
	...
	var MenuBtnStatus = exports.MenuBtnStatus = function (_React$Component2) {
	  _inherits(MenuBtnStatus, _React$Component2);

	  function MenuBtnStatus() {
	    _classCallCheck(this, MenuBtnStatus);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(MenuBtnStatus).apply(this, arguments));
	  }

	  _createClass(MenuBtnStatus, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('input', { type: 'checkbox', id: 'menu-slider', name: 'menu-slider' });
	    }
	  }]);

	  return MenuBtnStatus;
	}(_react2.default.Component);

	var SearchBtn = exports.SearchBtn = function (_React$Component3) {
	  _inherits(SearchBtn, _React$Component3);
	...
	var Wrap = exports.Wrap = function (_React$Component4) {
	  ...
	  _createClass(Wrap, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { id: 'wrap' },
	        _react2.default.createElement(MenuBtnStatus, null),
	        _react2.default.createElement(MenuBtn, null),
	...
	_reactDom2.default.render(_react2.default.createElement(Wrap, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Blog = exports.Posts = exports.PostsItem = undefined;
	...
	var PostsItem = exports.PostsItem = function (_React$Component) {
		...
		function PostsItem() {
			_classCallCheck(this, PostsItem);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(PostsItem).apply(this, arguments));
		}

		_createClass(PostsItem, [{
			key: 'render',
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'section',
						{ className: 'content' },
						post.thumb !== '' ? _react2.default.createElement('img', { src: post.thumb, alt: post.title }) : '',
						_react2.default.createElement(
							'p',
							null,
							post.content
	...
	var Posts = exports.Posts = function (_React$Component2) {
		...
		_createClass(Posts, [{
			...
			value: function render() {
				...
				var posts = this.props.data.map(function (post) {
					...
					return _react2.default.createElement(PostsItem, { data: post, key: post.id });
				});
	...
	var Blog = exports.Blog = function (_React$Component3) {
		...
		_createClass(Blog, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(Posts, { data: data });
			}
		}]);
